...
//	vector< vector <float> > newGrid;
	...
	// your code here
	vector< vector <float> > newGrid(grid.size(), vector<float>(grid[0].size(), 1.0));
	cout << "initialize_beliefs being tested !\n";
...
//	vector < vector <float> > newGrid;
	...
	cout << "move function being tested !\n";
